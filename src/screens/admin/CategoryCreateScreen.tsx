...
export default function CategoryCreateScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const message =
        err.response?.data?.message || err.message || 'Erro ao cadastrar categoria';
  ...
  return (
    <ScreenContainer>
      <Text style={styles.screenTitle}>Nova Categoria</Text>
      <Text style={styles.screenSubtitle}>Preencha os dados para cadastrar uma categoria</Text>
