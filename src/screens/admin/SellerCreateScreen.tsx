...
export default function SellerCreateScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const message =
        err.response?.data?.message || err.message || 'Erro ao cadastrar vendedor';
  ...
  return (
    <ScreenContainer>
      <Text style={styles.screenTitle}>Novo Vendedor</Text>
      <Text style={styles.screenSubtitle}>Preencha os dados para cadastrar um vendedor</Text>
