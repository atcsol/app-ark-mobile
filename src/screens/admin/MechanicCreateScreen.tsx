...
export default function MechanicCreateScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      await adminApi.createMechanic(data);
      Alert.alert('Sucesso', 'Mecanico cadastrado com sucesso.', [
        { text: 'OK', onPress: () => router.back() },
      ]);
    } catch (err: any) {
      const message =
        err.response?.data?.message || err.message || 'Erro ao cadastrar mecanico';
  ...
  return (
    <ScreenContainer>
      <Text style={styles.screenTitle}>Novo Mecanico</Text>
      <Text style={styles.screenSubtitle}>Preencha os dados para cadastrar um mecanico</Text>
